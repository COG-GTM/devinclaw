...
10. **Run guardrails validation per session**
 ...
 - HG-002: CIS Benchmark scan clean.
...
- **Sensitivity**: All migration artifacts must be marked CONFIDENTIAL — INTERNAL USE ONLY unless otherwise directed.
...
*Source: skills/parallel-migration/SKILL.md*
