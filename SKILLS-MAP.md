...
| `security-scan` | CIS Benchmark compliance | Automated security | Cloud + Review |
...
- **Trigger:** "security scan", "security benchmark check", "security compliance", "cloud security compliance audit", "vulnerability scan"
...
- **MCP Required:** SonarQube, Security Benchmark Scanner, Security Controls
...
|-----------------|-----------------|-----------------|
| Auto-Triage Bugs via Linear | Jira ticket → auto-investigate enterprise bugs | `incident-response` |
...
| Auto-Investigate Datadog Alerts | enterprise operational monitoring | `incident-response` |
